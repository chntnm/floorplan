...
| **2** | **Plan editor** — Konva stage, pan/zoom, wall/room/shape tools, dimension tool, grid + snapping, selection and transform, mode toggle, undo/redo. Draw a floor plan by hand and save it. |
